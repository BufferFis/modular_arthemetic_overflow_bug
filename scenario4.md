...
- **Montgomery:** Attacker submits $a$ and $b$ such that $a \times b > 2^{16}$; the system computes $(a \times b) \% 2^{16}$, losing high bits, and then applies REDC, producing a wrong result.
...
$(60,000 \times 2,000) \% 65,521 = 120,000,000 \% 65,521 = 22,678$
